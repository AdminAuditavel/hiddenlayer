...
import systemLatentStateMockup from "../products/Modelo-Descolado-Blusa-Branca-LATENT-STATE.png";
            ...
            <div className="rounded-lg overflow-hidden border border-black/5 bg-white">
              ...
              <div className="p-10 text-center">
                ...
                <button
                  ...
                  className="px-6 py-2 border border-black/20 text-[9px] uppercase tracking-[0.3em] text-black/60 rounded hover:border-primary/60 hover:text-primary transition-colors"
                >
                  Explore Collection
                </button>
              </div>
                  ...
                  <div className="flex items-center justify-center p-10">
                    <div className="text-center md:text-left max-w-sm">
                      ...
                      <button
                        ...
                        onClick={() =>
                          window.open(
                            "https://hotprinti.com.br/hiddenlayer/product/1399bc85-c2d6-4ee9-b2de-a239afd91ca0/",
                            "_blank",
                            "noopener,noreferrer"
                          )
                        }
